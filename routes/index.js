...
router.get('/helper', function(req, res, next){
    res.render('helper', {
        ...
        deals: [
            ...
            {
                "is_publish": "1",
                "name": "Philips HTB7150 Blu Ray Buletooth Soundbar with Subwoofer Rs. 27999 "
            },
            {
                "is_publish": "0",
            ...
            {
                "is_publish":"0",
                "name": "HealthKart Health & Beatufy Products Rs. 100 off on Rs 101"
            }
        ]
    });
});
